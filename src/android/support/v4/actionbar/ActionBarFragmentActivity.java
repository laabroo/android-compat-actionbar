 ...
 * {@link ActionBarHelper}. NOTE: dynamically marking menu items as invisible/visible is not
 * currently supported.
 * <p>
...
public abstract class ActionBarFragmentActivity extends FragmentActivity {
     ...
     * {@link Activity#onCreateOptionsMenu(android.view.Menu)}. Note: marking menu items as
     * invisible/visible is not currently supported.
     */
    @Override
